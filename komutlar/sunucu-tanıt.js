...
exports.run = async (client, message, args) => {    let cooldown = 8.64e+7, // 24 Saat
    ...
    .setDescription(' Bu Komutu Sadece `24 Saatte` Bir Kullanabilirsin. \n\n[Destek Sunucuma Gitmek İçin Tıkla](https://discord.gg/n8rhzAU6vJ)\n[Beni Sunucuna Eklemek İçin Tıkla](https://discordapp.com/oauth2/authorize?client_id=784373795283664906&scope=bot&permissions=2146958847)')
			.setColor(0x00ffff)
...
.setDescription(' **Sunucunuz Başarıyla** [Destek Sunucumda](https://discord.gg/n8rhzAU6vJ) **Tanıtıldı.**\n**24 Saat Sonra Tekrar Sunucunuzu Tanıtabilirsiniz.**')
        .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('792738919216709691').send(embed)
